...
\subsubsection{Compiling using default binary type, using OpenMPI and DynInst}

\graybox{{\tt ./configure --prefix=PREFIX --with-mpi=/home/harald/aplic/openmpi/1.3.1 --with-dyninst=/home/harald/dyninst/7.0.1 --with-dwarf=/usr}}
