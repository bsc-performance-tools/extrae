...
\begin{itemize}
    ...
    \item {\tt --with-openmp-ompt=HEADER} \\
    Enables support for tracing OpenMP runtimes through the OMPT specification. This mechanism requires an OpenMP-related header with the OMPT information. \textbf{NOTE:} enabling this option disables the regular instrumentation system available through \texttt{--enable-openmp-ibm}, \texttt{--enable-openmp-intel} and \texttt{--enable-openmp-gnu}.
	\item {\tt --enable-smpss} \\
