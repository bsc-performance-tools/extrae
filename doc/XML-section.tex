...
There are two points where the instrumentation can gather this information:
...
\graybox{See {\bf MPITRACE\_INITIAL\_MODE}, {\bf MPITRACE\_BURST\_THRESHOLD} and {MPITRACE\_MPI\_STATISTICS} environment variables in appendix \ref{cha:EnvVar}.}
