...
\begin{tabular}{| l | l |}
  ...
  \hline
  MPITRACE\_DISABLE\_PACX & Disable PACX instrumentation\\
  \hline
  ...
  \hline
  MPITRACE\_PACX\_CALLER & Choose which PACX calling routines should be dumped into the\\
                        & tracefile\\
  \hline
  MPITRACE\_PACX\_COUNTERS\_ON & Set to 1 if PACX must report performace counter values\\
  \hline 
  MPITRACE\_PACX\_STATISTICS & Set to 1 if basic PACX statistics must be collected in burst mode\\
  \hline
