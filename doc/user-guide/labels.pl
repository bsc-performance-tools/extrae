...
$key = q/sec:OpenMPruntimesinstrumented/;
$external_labels{$key} = "$URL/" . q|user-guide.html|; 
$noresave{$key} = "$nosave";
...
$key = q/fig:Overhead_Extrae_3_3_0/;
$external_labels{$key} = "$URL/" . q|user-guide.html|; 
$noresave{$key} = "$nosave";
...
$key = q/sec:OpenMPruntimesinstrumented/;
$external_latex_labels{$key} = q|F.3|; 
$noresave{$key} = "$nosave";
...
$key = q/sec:CUDAinstrumentedroutines/;
$external_latex_labels{$key} = q|F.4|; 
$noresave{$key} = "$nosave";
...
$key = q/sec:OPENCLinstrumentedroutines/;
$external_latex_labels{$key} = q|F.5|; 
$noresave{$key} = "$nosave";
