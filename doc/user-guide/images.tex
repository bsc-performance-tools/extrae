...
\providecommand{\TRACEVERSION}{3.0.3rc} 
...
\input /home/harald/development/extrae/trunk-jlesc-experiments/doc/user-guide.aux
\makeatother
}
...
\stepcounter{chapter}
{\newpage\clearpage
\lthtmlfigureA{landscape4318}%
\begin{landscape}
% latex2html id marker 4318
...
\begin{tabular}{| p{7cm} | p{14cm} |}
  ...
  \hline
  EXTRAE\_HOME & Points where the {\sf {E}xtrae}\ is installed.\\
  \hline
...
{\newpage\clearpage
\lthtmlfigureA{landscape4339}%
\begin{landscape}
% latex2html id marker 4339
