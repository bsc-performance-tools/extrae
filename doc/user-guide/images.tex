...
\stepcounter{chapter}
{\newpage\clearpage
\lthtmlfigureA{landscape4449}%
\begin{landscape}
% latex2html id marker 4449
...
{\newpage\clearpage
\lthtmlfigureA{landscape4545}%
\begin{landscape}
% latex2html id marker 4545
...
\begin{tabular}{p{7.5cm} p{14cm}} 
  ...
  \cellcolor{tabbg2} EXTRAE\_SKIP\_AUTO\_LIBRARY\_INITIALIZE & \cellcolor{tabbg2} Do not automatically instrument the main symbol.\\
