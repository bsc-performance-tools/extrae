...
\section{MPI instrumented routines}\label{sec:MPIinstrumentedroutines}
...
\section{OpenMP runtimes instrumented}\label{sec:OpenMPruntimesinstrumented}
...
\TRACE supports Intel OpenMP runtime 8.1, 9.1 and 10.1.
