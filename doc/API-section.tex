...
The following routines are defined in the {\tt \$\{EXTRAE\_HOME\}/include/mpitrace\_user\_events.h}.
...
Instead of including {\tt \$\{EXTRAE\_HOME\}/include/mpitrace\_user\_events.h} include:
\begin{itemize}
