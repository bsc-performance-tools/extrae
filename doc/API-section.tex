...
\begin{itemize}
	...
	Registers type t1 to reference user source code location (assigning type t1 to the event type that references the user function and to the event t2 to the event that references the file name and line location).
