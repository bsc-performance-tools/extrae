...
\begin{itemize}
  ...
  \item {\tt void Event(int id, long val);}

  \item {\tt void nEvent(int types[], long values[]);}

  \item {\tt void defineEventType(int type, String description, long nValues, long[] values, String[] descriptionValues);}

  \item {\tt void SetOptions(int options);}

  \item {\tt void Shutdown();}
