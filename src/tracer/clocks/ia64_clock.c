...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $Source: /home/paraver/cvs-tools/mpitrace/fusion/src/tracer/clocks/ia64_clock.c,v $
 | 
 | @last_commit: $Date: 2008/02/14 14:12:37 $
...
static char UNUSED rcsid[] = "$Id: ia64_clock.c,v 1.4 2008/02/14 14:12:37 harald Exp $";
