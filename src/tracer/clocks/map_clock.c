...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $Source: /home/paraver/cvs-tools/mpitrace/fusion/src/tracer/clocks/map_clock.c,v $
 | 
...
static char UNUSED rcsid[] = "$Id: map_clock.c,v 1.3 2008/01/26 11:18:22 harald Exp $";
