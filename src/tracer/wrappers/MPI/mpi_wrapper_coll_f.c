	...
	MPI_Fint *ierror)
{
  ...
  TRACE_MPIEVENT (begin_time, MPI_REDUCE_EV, EVT_BEGIN, *op, size, me, c, *root);
	...
	*/
	...
	if (me == *root)
	{
		_xtr_stats_MPI_update_collective(begin_time, current_time, size, 0, c);
	}
	else
	{
		_xtr_stats_MPI_update_collective(begin_time, current_time, 0, size, c);
	}
	...
	MPI_Fint *datatype, MPI_Fint *op, MPI_Fint *comm, MPI_Fint *ierror)
{
  ...
  TRACE_MPIEVENT (begin_time, MPI_ALLREDUCE_EV, EVT_BEGIN, *op, size, me, c, EMPTY);
	...
	*/
	...
	/* MPI Stats */
	_xtr_stats_MPI_update_collective(begin_time, current_time, size, size, c);
...
void PMPI_Barrier_Wrapper (MPI_Fint *comm, MPI_Fint *ierror)
{
  ...
  /* MPI Stats */
  _xtr_stats_MPI_update_collective(begin_time, current_time, 0, 0, c);
	...
	MPI_Fint *comm, MPI_Fint *ierror)
{
  ...
  TRACE_MPIEVENT (begin_time, MPI_ALLTOALL_EV, EVT_BEGIN, EMPTY,
	...
	*/
	...
	/* MPI Stats */
	_xtr_stats_MPI_update_collective(begin_time, current_time, *recvcount * recvsize * csize,  *sendcount * sendsize, c);
	...
	MPI_Fint *rdispls, MPI_Fint *recvtype,	MPI_Fint *comm, MPI_Fint *ierror)
{
  ...
  TRACE_MPIEVENT (begin_time, MPI_ALLTOALLV_EV, EVT_BEGIN, EMPTY,
	...
	*/
	...
	/* MPI Stats */
	_xtr_stats_MPI_update_collective(begin_time, current_time, recvc * recvsize, sendc * sendsize, c);
	...
	MPI_Fint *recvtype, MPI_Fint *comm, MPI_Fint *ierror)
{
  ...
  TRACE_MPIEVENT (begin_time, MPI_ALLGATHERV_EV, EVT_BEGIN, EMPTY,
	...
	*/
	...
	/* MPI Stats */
	_xtr_stats_MPI_update_collective(begin_time, current_time, recvc * recvsize, *sendcount * sendsize, c);
	...
	MPI_Fint *root, MPI_Fint *comm, MPI_Fint *ierror)
{
  ...
  TRACE_MPIEVENT (begin_time, MPI_GATHER_EV, EVT_BEGIN, *root, *sendcount * sendsize,
	...
	*/
	...
	if (me == *root)
	{
		_xtr_stats_MPI_update_collective(begin_time, current_time, *recvcount * recvsize * csize, 0, c);
	}
	else
	{
		_xtr_stats_MPI_update_collective(begin_time, current_time, 0, *sendcount * sendsize, c);
	}
	...
	MPI_Fint *recvtype, MPI_Fint *root, MPI_Fint *comm, MPI_Fint *ierror)
{
  ...
  TRACE_MPIEVENT (begin_time, MPI_GATHERV_EV, EVT_BEGIN, *root, *sendcount * sendsize,
	...
	*/
	...
	if (me == *root)
	{
		_xtr_stats_MPI_update_collective(begin_time, current_time, recvc * recvsize, 0, c);
	}
	else
	{
		_xtr_stats_MPI_update_collective(begin_time, current_time, 0, *sendcount * sendsize, c);
	...
	MPI_Fint *root, MPI_Fint *comm, MPI_Fint *ierror)
{
  ...
  iotimer_t begin_time = LAST_READ_TIME;
	...
	*/
	...
	if (me == *root)
	{
		_xtr_stats_MPI_update_collective(begin_time, current_time, 0, *sendcount * sendsize * csize, c);
	}
	else
	{
		_xtr_stats_MPI_update_collective(begin_time, current_time, *recvcount * recvsize, 0, c);
	}
	...
	MPI_Fint *recvtype, MPI_Fint *root, MPI_Fint *comm, MPI_Fint *ierror)
{
  ...
  iotimer_t begin_time = LAST_READ_TIME;
	...
	*/
	...
	if (me == *root)
	{
		_xtr_stats_MPI_update_collective(begin_time, current_time, 0, sendc * sendsize, c);
	}
	else
	{
		_xtr_stats_MPI_update_collective(begin_time, current_time, *recvcount * recvsize, 0, c);
	...
	MPI_Fint *ierror)
{
  ...
  TRACE_MPIEVENT (begin_time, MPI_REDUCESCAT_EV, EVT_BEGIN, *op, size, me, c, EMPTY);
	...
	*/
	...
	if (me == 0)
	{
		_xtr_stats_MPI_update_collective(begin_time, current_time, sendcount * size, sendcount * size, c);
	}
	else
	{
		_xtr_stats_MPI_update_collective(begin_time, current_time, recvcounts[me] * size, sendcount * size, c);
	}
	...
	MPI_Fint *datatype, MPI_Fint *op, MPI_Fint *comm, MPI_Fint *ierror)
{
  ...
  TRACE_MPIEVENT (begin_time, MPI_SCAN_EV, EVT_BEGIN, *op, *count * size, me, c, EMPTY);
	...
	*/
	...
	if (me != csize - 1)
	{
		_xtr_stats_MPI_update_collective(begin_time, current_time, 0, *count * size, c);
	}
	if (me != 0)
	{
		_xtr_stats_MPI_update_collective(begin_time, current_time, *count * size, 0, c);
	}
	...
	MPI_Fint *ierror)
{
  ...
  TRACE_MPIEVENT (begin_time, MPI_REDUCE_SCATTER_BLOCK_EV, EVT_BEGIN, *op, size, me, c, EMPTY);
	...
	*/
	...
	{
		_xtr_stats_MPI_update_collective(begin_time, current_time, *recvcount * size, sendcount * size, c);
	}
	...
	MPI_Fint *rdispls, MPI_Fint *recvtypes,	MPI_Fint *comm, MPI_Fint *ierror)
{
  ...
  TRACE_MPIEVENT (begin_time, MPI_ALLTOALLW_EV, EVT_BEGIN, EMPTY,
	...
	*/
	...
	/* MPI Stats */
	_xtr_stats_MPI_update_collective(begin_time, current_time, recvbytes, sendbytes, c);
...
void PMPI_Neighbor_allgather_Wrapper (void *sendbuf, MPI_Fint *sendcount, MPI_Fint *sendtype, void *recvbuf, MPI_Fint *recvcount, MPI_Fint *recvtype, MPI_Fint *comm, MPI_Fint *ierr)
{
  ...
  /* MPI Stats */
  _xtr_stats_MPI_update_collective(begin_time, current_time, *recvcount * recvsize * indegree, *sendcount * sendsize, c);
