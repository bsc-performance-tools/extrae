...
{
	if (mpitrace_on)
		TRACE_MISCEVENTANDCOUNTERS(LAST_READ_TIME, OPENACC_EV, EVT_BEGIN, OPENACC_ENQUEUE_KERNEL_LAUNCH_VAL);
}
...
{
	if (mpitrace_on)
		TRACE_MISCEVENTANDCOUNTERS(TIME, OPENACC_EV, EVT_END, OPENACC_ENQUEUE_KERNEL_LAUNCH_VAL);
}
...
{
	if (mpitrace_on)
		TRACE_MISCEVENTANDCOUNTERS(LAST_READ_TIME, OPENACC_EV, EVT_BEGIN, OPENACC_ENQUEUE_UPLOAD_VAL);
}
...
{
	if (mpitrace_on)
		TRACE_MISCEVENTANDCOUNTERS(TIME, OPENACC_EV, EVT_END, OPENACC_ENQUEUE_UPLOAD_VAL);
}
...
{
	if (mpitrace_on)
		TRACE_MISCEVENTANDCOUNTERS(LAST_READ_TIME, OPENACC_EV, EVT_BEGIN, OPENACC_ENQUEUE_DOWNLOAD_VAL);
}
...
{
	if (mpitrace_on)
		TRACE_MISCEVENTANDCOUNTERS(TIME, OPENACC_EV, EVT_END, OPENACC_ENQUEUE_DOWNLOAD_VAL);
}
