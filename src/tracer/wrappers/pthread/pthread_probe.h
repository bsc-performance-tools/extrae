...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $HeadURL: https://svn.bsc.es/repos/ptools/extrae/trunk/src/tracer/probes/pthread/pthread_probe.h $
 | @last_commit: $Date: 2013-05-21 15:33:05 +0200 (Tue, 21 May 2013) $
