...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $Source: /home/paraver/cvs-tools/mpitrace/fusion/src/tracer/spu/spu_clock.h,v $
 | 
...
#ifndef __SPU_CLOCK_H__
#define __SPU_CLOCK_H__
...
unsigned long long get_spu_time();

#endif /* __SPU_CLOCK_H__ */
