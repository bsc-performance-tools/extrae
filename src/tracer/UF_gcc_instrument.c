...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $Source: /home/paraver/cvs-tools/mpitrace/fusion/src/tracer/UF_gcc_instrument.c,v $
 | 
...
static char UNUSED rcsid[] = "$Id: UF_gcc_instrument.c,v 1.6 2009/05/28 13:38:53 harald Exp $";
