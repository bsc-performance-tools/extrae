...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $Source: /home/paraver/cvs-tools/mpitrace/fusion/src/tracer/persistent_requests.c,v $
 | 
...
static char UNUSED rcsid[] = "$Id: persistent_requests.c,v 1.5 2008/07/21 13:39:18 harald Exp $";
