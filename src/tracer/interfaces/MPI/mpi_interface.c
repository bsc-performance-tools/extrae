...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $Source: /home/paraver/cvs-tools/mpitrace/fusion/src/tracer/interfaces/MPI/mpi_interface.c,v $
 | 
...
static char UNUSED rcsid[] = "$Id: mpi_interface.c,v 1.31 2009/09/23 16:56:11 harald Exp $";
