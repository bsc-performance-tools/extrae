...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $Source: /home/paraver/cvs-tools/mpitrace/fusion/src/others/papi_best_set.c,v $
 | 
 | @last_commit: $Date: 2009/09/03 14:48:27 $
...
static char UNUSED rcsid[] = "$Id: papi_best_set.c,v 1.4 2009/09/03 14:48:27 harald Exp $";
