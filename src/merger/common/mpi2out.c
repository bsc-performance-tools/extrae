...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $Source: /home/paraver/cvs-tools/mpitrace/fusion/src/merger/common/mpi2out.c,v $
 | 
...
static char UNUSED rcsid[] = "$Id: mpi2out.c,v 1.23 2009/05/28 14:40:44 harald Exp $";
