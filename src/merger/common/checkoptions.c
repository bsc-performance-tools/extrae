...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $Source: /home/paraver/cvs-tools/mpitrace/fusion/src/merger/common/checkoptions.c,v $
 | 
...
static char UNUSED rcsid[] = "$Id: checkoptions.c,v 1.4 2009/05/28 14:40:44 harald Exp $";
