...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $Source: /home/paraver/cvs-tools/mpitrace/fusion/src/merger/paraver/omp_prv_semantics.c,v $
 | 
...
static char UNUSED rcsid[] = "$Id: omp_prv_semantics.c,v 1.10 2009/05/28 14:40:44 harald Exp $";
