...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $Source: /home/paraver/cvs-tools/mpitrace/fusion/src/merger/paraver/mpi_prv_events.c,v $
 | 
 | @last_commit: $Date: 2009/05/27 10:16:34 $
...
static char UNUSED rcsid[] = "$Id: mpi_prv_events.c,v 1.5 2009/05/27 10:16:34 harald Exp $";
...
struct t_event_mpit2prv event_mpit2prv[NUM_PRV_ELEMENTS] = {
	...
	{-1, MPITYPE_COMM, MPI_INTERCOMM_CREATE_VAL, FALSE},  /*  43 */
	{-1, MPITYPE_COMM, MPI_INTERCOMM_MERGE_VAL, FALSE},   /*  44 */
	...
	{-1, MPITYPE_OTHER, MPI_TESTSOME_VAL, FALSE}, /*  94 */
	...
	{-1, MPITYPE_RMA, MPI_WIN_CREATE_VAL, FALSE}, /* 128 */
	{-1, MPITYPE_RMA, MPI_WIN_FREE_VAL, FALSE},   /* 129 */
	{-1, MPITYPE_RMA, MPI_PUT_VAL, FALSE},        /* 130 */
	{-1, MPITYPE_RMA, MPI_GET_VAL, FALSE},        /* 131 */
	{-1, MPITYPE_RMA, MPI_ACCUMULATE_VAL, FALSE}, /* 132 */
	{-1, MPITYPE_RMA, MPI_WIN_FENCE_VAL, FALSE},  /* 133 */
	{-1, MPITYPE_RMA, MPI_WIN_START_VAL, FALSE},  /* 134 */
	{-1, MPITYPE_RMA, MPI_WIN_COMPLETE_VAL, FALSE},       /* 135 */
	{-1, MPITYPE_RMA, MPI_WIN_POST_VAL, FALSE},   /* 136 */
	{-1, MPITYPE_RMA, MPI_WIN_WAIT_VAL, FALSE},   /* 137 */
