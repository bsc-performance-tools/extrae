...
#define NUM_MPI_PRV_ELEMENTS 215 /*MPI_IEXSCAN*/
...
static struct t_event_mpit2prv event_mpit2prv[NUM_MPI_PRV_ELEMENTS] = {
	...
	{MPI_INTERCOMM_MERGE_EV, MPITYPE_COMM, MPI_INTERCOMM_MERGE_VAL, FALSE},   /*  44 */
	...
	{MPI_GRAPH_CREATE_EV, MPITYPE_TOPOLOGIES, MPI_GRAPH_CREATE_VAL, FALSE},        /* 124 */
	...
	{MPI_IALLTOALL_EV, MPITYPE_COLLECTIVE, MPI_IALLTOALL_VAL, FALSE},
	...
	{MPI_DIST_GRAPH_CREATE_EV, MPITYPE_TOPOLOGIES, MPI_DIST_GRAPH_CREATE_VAL, FALSE},
	{MPI_NEIGHBOR_ALLGATHER_EV, MPITYPE_COLLECTIVE, MPI_NEIGHBOR_ALLGATHER_VAL, FALSE},
	{MPI_INEIGHBOR_ALLGATHER_EV, MPITYPE_COLLECTIVE, MPI_INEIGHBOR_ALLGATHER_VAL, FALSE},
	{MPI_NEIGHBOR_ALLGATHERV_EV, MPITYPE_COLLECTIVE, MPI_NEIGHBOR_ALLGATHERV_VAL, FALSE},
	{MPI_INEIGHBOR_ALLGATHERV_EV, MPITYPE_COLLECTIVE, MPI_INEIGHBOR_ALLGATHERV_VAL, FALSE},
	{MPI_NEIGHBOR_ALLTOALL_EV, MPITYPE_COLLECTIVE, MPI_NEIGHBOR_ALLTOALL_VAL, FALSE},
	{MPI_INEIGHBOR_ALLTOALL_EV, MPITYPE_COLLECTIVE, MPI_INEIGHBOR_ALLTOALL_VAL, FALSE},
	{MPI_NEIGHBOR_ALLTOALLV_EV, MPITYPE_COLLECTIVE, MPI_NEIGHBOR_ALLTOALLV_VAL, FALSE}, /* 180 */
	{MPI_INEIGHBOR_ALLTOALLV_EV, MPITYPE_COLLECTIVE, MPI_INEIGHBOR_ALLTOALLV_VAL, FALSE},
	{MPI_NEIGHBOR_ALLTOALLW_EV, MPITYPE_COLLECTIVE, MPI_NEIGHBOR_ALLTOALLW_VAL, FALSE},
	{MPI_INEIGHBOR_ALLTOALLW_EV, MPITYPE_COLLECTIVE, MPI_INEIGHBOR_ALLTOALLW_VAL, FALSE},
	{MPI_FETCH_AND_OP_EV, MPITYPE_RMA, MPI_FETCH_AND_OP_VAL, FALSE},
	{MPI_COMPARE_AND_SWAP_EV, MPITYPE_RMA, MPI_COMPARE_AND_SWAP_VAL, FALSE}, /* 185 */
	{MPI_WIN_FLUSH_EV, MPITYPE_RMA, MPI_WIN_FLUSH_VAL, FALSE},
	{MPI_WIN_FLUSH_ALL_EV, MPITYPE_RMA, MPI_WIN_FLUSH_ALL_VAL, FALSE},
	{MPI_WIN_FLUSH_LOCAL_EV, MPITYPE_RMA, MPI_WIN_FLUSH_LOCAL_VAL, FALSE},
	{MPI_WIN_FLUSH_LOCAL_ALL_EV, MPITYPE_RMA, MPI_WIN_FLUSH_LOCAL_ALL_VAL, FALSE},
	{MPI_MPROBE_EV, MPITYPE_PTOP, MPI_MPROBE_VAL, FALSE}, /* 190 */
	{MPI_IMPROBE_EV, MPITYPE_PTOP, MPI_IMPROBE_VAL, FALSE},
	{MPI_MRECV_EV, MPITYPE_PTOP, MPI_MRECV_VAL, FALSE},
	{MPI_IMRECV_EV, MPITYPE_PTOP, MPI_IMRECV_VAL, FALSE},
	{MPI_COMM_SPLIT_TYPE_EV, MPITYPE_COMM, MPI_COMM_SPLIT_TYPE_VAL, FALSE},
	{MPI_FILE_WRITE_ALL_BEGIN_EV, MPITYPE_IO, MPI_FILE_WRITE_ALL_BEGIN_VAL, FALSE}, /* 195 */
	{MPI_FILE_WRITE_ALL_END_EV, MPITYPE_IO, MPI_FILE_WRITE_ALL_END_VAL, FALSE},
	{MPI_FILE_READ_ALL_BEGIN_EV, MPITYPE_IO, MPI_FILE_READ_ALL_BEGIN_VAL, FALSE},
	{MPI_FILE_READ_ALL_END_EV, MPITYPE_IO, MPI_FILE_READ_ALL_END_VAL, FALSE},
	{MPI_FILE_WRITE_AT_ALL_BEGIN_EV, MPITYPE_IO, MPI_FILE_WRITE_AT_ALL_BEGIN_VAL, FALSE},
	{MPI_FILE_WRITE_AT_ALL_END_EV, MPITYPE_IO, MPI_FILE_WRITE_AT_ALL_END_VAL, FALSE}, /* 200 */
	{MPI_FILE_READ_AT_ALL_BEGIN_EV, MPITYPE_IO, MPI_FILE_READ_AT_ALL_BEGIN_VAL, FALSE},
	{MPI_FILE_READ_AT_ALL_END_EV, MPITYPE_IO, MPI_FILE_READ_AT_ALL_END_VAL, FALSE},
	{MPI_FILE_READ_ORDERED_EV, MPITYPE_IO, MPI_FILE_READ_ORDERED_VAL, FALSE},
	{MPI_FILE_READ_ORDERED_BEGIN_EV, MPITYPE_IO, MPI_FILE_READ_ORDERED_BEGIN_VAL, FALSE},
	{MPI_FILE_READ_ORDERED_END_EV, MPITYPE_IO, MPI_FILE_READ_ORDERED_END_VAL, FALSE}, /* 205 */
	{MPI_FILE_READ_SHARED_EV, MPITYPE_IO, MPI_FILE_READ_SHARED_VAL, FALSE},
	{MPI_FILE_WRITE_ORDERED_EV, MPITYPE_IO, MPI_FILE_WRITE_ORDERED_VAL, FALSE},
	{MPI_FILE_WRITE_ORDERED_BEGIN_EV, MPITYPE_IO, MPI_FILE_WRITE_ORDERED_BEGIN_VAL, FALSE},
	{MPI_FILE_WRITE_ORDERED_END_EV, MPITYPE_IO, MPI_FILE_WRITE_ORDERED_END_VAL, FALSE},
	{MPI_FILE_WRITE_SHARED_EV, MPITYPE_IO, MPI_FILE_WRITE_SHARED_VAL, FALSE}, /* 210 */
	{MPI_COMM_DUP_WITH_INFO_EV, MPITYPE_COMM, MPI_COMM_DUP_WITH_INFO_VAL, FALSE},
	{MPI_DIST_GRAPH_CREATE_ADJACENT_EV, MPITYPE_TOPOLOGIES, MPI_DIST_GRAPH_CREATE_ADJACENT_VAL, FALSE},
	{MPI_COMM_CREATE_GROUP_EV, MPITYPE_COMM, MPI_COMM_CREATE_GROUP_VAL, FALSE},
	{MPI_EXSCAN_EV, MPITYPE_COLLECTIVE, MPI_EXSCAN_VAL, FALSE},
	{MPI_IEXSCAN_EV, MPITYPE_COLLECTIVE, MPI_IEXSCAN_VAL, FALSE} /* 215 */
};
...
static struct t_prv_val_label mpi_prv_val_label[NUM_MPI_PRV_ELEMENTS] = {
	...
	{MPI_COMM_CREATE_GROUP_VAL, MPI_COMM_CREATE_GROUP_LABEL},
	...
	{MPI_INEIGHBOR_ALLTOALL_VAL, MPI_INEIGHBOR_ALLTOALL_LABEL},
	...
	{MPI_COMM_SPLIT_TYPE_VAL, MPI_COMM_SPLIT_TYPE_LABEL},
	{MPI_FILE_WRITE_ALL_BEGIN_VAL, MPI_FILE_WRITE_ALL_BEGIN_LABEL},
	{MPI_FILE_WRITE_ALL_END_VAL, MPI_FILE_WRITE_ALL_END_LABEL},
	{MPI_FILE_READ_ALL_BEGIN_VAL, MPI_FILE_READ_ALL_BEGIN_LABEL},
	{MPI_FILE_READ_ALL_END_VAL, MPI_FILE_READ_ALL_END_LABEL},
	{MPI_FILE_WRITE_AT_ALL_BEGIN_VAL, MPI_FILE_WRITE_AT_ALL_BEGIN_LABEL},
	{MPI_FILE_WRITE_AT_ALL_END_VAL, MPI_FILE_WRITE_AT_ALL_END_LABEL},
	{MPI_FILE_READ_AT_ALL_BEGIN_VAL, MPI_FILE_READ_AT_ALL_BEGIN_LABEL},
	{MPI_FILE_READ_AT_ALL_END_VAL, MPI_FILE_READ_AT_ALL_END_LABEL},
	{MPI_FILE_READ_ORDERED_VAL, MPI_FILE_READ_ORDERED_LABEL},
	{MPI_FILE_READ_ORDERED_BEGIN_VAL, MPI_FILE_READ_ORDERED_BEGIN_LABEL},
	{MPI_FILE_READ_ORDERED_END_VAL, MPI_FILE_READ_ORDERED_END_LABEL},
	{MPI_FILE_READ_SHARED_VAL, MPI_FILE_READ_SHARED_LABEL},
	{MPI_FILE_WRITE_ORDERED_VAL, MPI_FILE_WRITE_ORDERED_LABEL},
	{MPI_FILE_WRITE_ORDERED_BEGIN_VAL, MPI_FILE_WRITE_ORDERED_BEGIN_LABEL},
	{MPI_FILE_WRITE_ORDERED_END_VAL, MPI_FILE_WRITE_ORDERED_END_LABEL},
	{MPI_FILE_WRITE_SHARED_VAL, MPI_FILE_WRITE_SHARED_LABEL},
	{MPI_COMM_DUP_WITH_INFO_VAL, MPI_COMM_DUP_WITH_INFO_LABEL},
	{MPI_DIST_GRAPH_CREATE_VAL, MPI_DIST_GRAPH_CREATE_LABEL}, 
	{MPI_DIST_GRAPH_CREATE_ADJACENT_VAL, MPI_DIST_GRAPH_CREATE_ADJACENT_LABEL},
	{MPI_EXSCAN_VAL, MPI_EXSCAN_LABEL},
	{MPI_IEXSCAN_VAL, MPI_IEXSCAN_LABEL}
};


#define IPROBE_CNT_INDEX                                    0
#define TIME_IN_IPROBE_INDEX                                1
#define TEST_CNT_INDEX                                      2
#define COLLECTIVE_INDEX                                    3
#define REQUEST_GET_STATUS_CNT_INDEX                        4
#define TIME_IN_REQUEST_GET_STATUS_INDEX                    5
#define IO_INDEX                                            6
#define TIME_IN_TEST_INDEX			                        7
#define IMPROBE_CNT_INDEX                                   8
#define TIME_IN_IMPROBE_INDEX                               9
#define MAX_SOFTCNT                                        10
...
void Enable_MPI_Soft_Counter (unsigned int EvType)
{
	...
	else if (EvType == MPI_TIME_IN_IPROBE_EV)
		MPI_SoftCounters_used[TIME_IN_IPROBE_INDEX] = TRUE;
        else if (EvType == MPI_IMPROBE_COUNTER_EV)
                MPI_SoftCounters_used[IMPROBE_CNT_INDEX] = TRUE;
        else if (EvType == MPI_TIME_IN_IMPROBE_EV)
                MPI_SoftCounters_used[TIME_IN_IMPROBE_INDEX] = TRUE;
	else if (EvType == MPI_TIME_IN_TEST_EV)
		MPI_SoftCounters_used[TIME_IN_TEST_INDEX] = TRUE;
...
#define TIME_IN_IPROBE_LBL                  "Elapsed time in MPI_Iprobe"
#define TIME_IN_TEST_LBL                    "Elapsed time in MPI_Test"
#define TEST_COUNTER_LBL                    "MPI_Test misses"
#define REQUEST_GET_STATUS_COUNTER_LBL  "MPI_Request_get_status counter"
#define TIME_IN_REQUEST_GET_STATUS_LBL      "Elapsed time in MPI_Request_get_status"
#define IMPROBE_COUNTER_LBL                 "MPI_Improbe misses"
#define TIME_IN_IMPROBE_LBL                 "Elapsed time in MPI_Improbe"
...
void SoftCountersEvent_WriteEnabled_MPI_Operations (FILE * fd)
{
	...
	if (MPI_SoftCounters_used[TIME_IN_IPROBE_INDEX])
	{
		fprintf (fd, "EVENT_TYPE\n");
		fprintf (fd, "%d    %d    %s\n\n", 0, 
			MPI_TIME_IN_IPROBE_EV, TIME_IN_IPROBE_LBL);
		LET_SPACES(fd);
	}
        if (MPI_SoftCounters_used[IMPROBE_CNT_INDEX])
        {
                fprintf (fd, "EVENT_TYPE\n");
                fprintf (fd, "%d    %d    %s\n\n", 0,
                        MPI_IMPROBE_COUNTER_EV, IMPROBE_COUNTER_LBL);
                LET_SPACES(fd);
        }
        if (MPI_SoftCounters_used[TIME_IN_IMPROBE_INDEX])
        {
                fprintf (fd, "EVENT_TYPE\n");
                fprintf (fd, "%d    %d    %s\n\n", 0,
                        MPI_TIME_IN_IMPROBE_EV, TIME_IN_IMPROBE_LBL);
                LET_SPACES(fd);
        }
	if (MPI_SoftCounters_used[TIME_IN_TEST_INDEX])
	{
		fprintf (fd, "EVENT_TYPE\n");
		fprintf (fd, "%d    %d    %s\n\n", 0, 
			MPI_TIME_IN_TEST_EV, TIME_IN_TEST_LBL);
		LET_SPACES(fd);
	}
	...
	if (MPI_SoftCounters_used[REQUEST_GET_STATUS_CNT_INDEX])
	{
		fprintf (fd, "EVENT_TYPE\n");
		fprintf (fd, "%d    %d    %s\n\n", 0, 
			MPI_REQUEST_GET_STATUS_COUNTER_EV, REQUEST_GET_STATUS_COUNTER_LBL);
		LET_SPACES(fd);
	}
	if (MPI_SoftCounters_used[TIME_IN_REQUEST_GET_STATUS_INDEX])
	{
		fprintf (fd, "EVENT_TYPE\n");
		fprintf (fd, "%d    %d    %s\n\n", 0, 
			MPI_TIME_IN_REQUEST_GET_STATUS_EV, TIME_IN_REQUEST_GET_STATUS_LBL);
		LET_SPACES(fd);
	}
