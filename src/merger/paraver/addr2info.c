...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $Source: /home/paraver/cvs-tools/mpitrace/fusion/src/merger/paraver/addr2info.c,v $
 | 
...
static char UNUSED rcsid[] = "$Id: addr2info.c,v 1.21 2009/05/28 13:06:55 harald Exp $";
