...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $Source: /home/paraver/cvs-tools/mpitrace/fusion/src/merger/paraver/send_queue.c,v $
 | 
...
static char UNUSED rcsid[] = "$Id: send_queue.c,v 1.1 2009/05/25 10:31:02 harald Exp $";
