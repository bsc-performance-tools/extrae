...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $Source: /home/paraver/cvs-tools/mpitrace/fusion/src/merger/paraver/file_set.c,v $
 | 
 | @last_commit: $Date: 2009/06/10 13:19:14 $
...
static char UNUSED rcsid[] = "$Id: file_set.c,v 1.32 2009/06/10 13:19:14 harald Exp $";
