...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $Source: /home/paraver/cvs-tools/mpitrace/fusion/src/merger/paraver/mpi_comunicadors.c,v $
 | 
...
static char UNUSED rcsid[] = "$Id: mpi_comunicadors.c,v 1.5 2008/07/21 13:39:18 harald Exp $";
