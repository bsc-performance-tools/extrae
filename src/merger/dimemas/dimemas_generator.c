...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $Source: /home/paraver/cvs-tools/mpitrace/fusion/src/merger/dimemas/dimemas_generator.c,v $
 | 
...
static char UNUSED rcsid[] = "$Id: dimemas_generator.c,v 1.9 2009/05/25 10:31:02 harald Exp $";
