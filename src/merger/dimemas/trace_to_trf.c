...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $Source: /home/paraver/cvs-tools/mpitrace/fusion/src/merger/dimemas/trace_to_trf.c,v $
 | 
...
static char UNUSED rcsid[] = "$Id: trace_to_trf.c,v 1.15 2009/05/28 14:40:44 harald Exp $";
