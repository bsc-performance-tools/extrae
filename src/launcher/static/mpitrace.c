...
/* -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=- *\
 | @file: $Source: /home/paraver/cvs-tools/mpitrace/fusion/src/launcher/static/mpitrace.c,v $
 | 
...
static char rcsid[] = "$Id: mpitrace.c,v 1.2 2008/01/26 11:18:22 harald Exp $" UNUSED;
