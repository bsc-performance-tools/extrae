...
static unsigned omp_events[] = { OMPFUNC_EV, PAR_EV, WSH_EV, BARRIEROMP_EV,
	...
	OMPGETNUMTHREADS_EV, OMPTASKYIELD_EV, TASK_EV, TASKWAIT_EV, TASKFUNC_EV, TASKFUNC_LINE_EV,
	...
	OMPT_TASKFUNC_EV, OMP_STATS_EV, TASKLOOP_EV, ORDERED_EV, TARGET_EV,
	NEW_OMP_CALL_EV, NEW_OMP_NESTED_EV, NEW_OMP_PARALLEL_EV,
	NEW_OMP_WSH_EV, NEW_OMP_SYNC_EV, NEW_OMP_LOCK_EV, NEW_OMP_LOCK_NAME_EV, 
	NEW_OMP_ORDERED_EV, NEW_OMP_TASKGROUP_EV, NEW_OMP_TASKING_EV, NEW_OMP_ADDRESS_EV,
	NEW_OMP_OUTLINED_ADDRESS_EV, NEW_OMP_OUTLINED_LINE_EV, NEW_OMP_TASK_INST_ID_EV,
	NEW_OMP_TASK_INST_ADDRESS_EV, NEW_OMP_TASK_INST_LINE_EV, NEW_OMP_TASK_EXEC_ID_EV,
