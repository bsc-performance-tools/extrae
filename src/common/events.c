...
static unsigned omp_events[] = { OMPFUNC_EV, PAR_EV, WSH_EV, BARRIEROMP_EV, 
    ...
    OMPGETNUMTHREADS_EV, TASKYIELD_EV, TASK_EV, TASKWAIT_EV, TASKFUNC_EV,
    TASKFUNC_LINE_EV, TASKGROUP_START_EV, TASKGROUP_END_EV, TASKID_EV, TASKLOOPID_EV,
    OMP_STATS_EV, TASKLOOP_EV, ORDERED_EV, TARGET_EV, NEW_OMP_CALL_EV, NEW_OMP_NESTED_EV,
...
static unsigned cuda_events[] = {
	...
	CUDA_UNTRACKED_EV, CUDA_STREAM_REGISTER_EV
};
