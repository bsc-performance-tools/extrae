...
#define MPI_EVENTS 151  // Last added MPI_COMM_DUP_WITH_INFO_EV
...
static unsigned mpi_events[] = {
	...
	MPI_DIST_GRAPH_CREATE_EV, MPI_NEIGHBOR_ALLGATHER_EV,
 ...
 ***  IsMISC
 ******************************************************************************/
#define MISC_EVENTS 69
static unsigned misc_events[] = {FLUSH_EV, OPEN_EV, FOPEN_EV, READ_EV, WRITE_EV, FREAD_EV, FWRITE_EV, 
        PREAD_EV, PWRITE_EV, READV_EV, WRITEV_EV, PREADV_EV, PWRITEV_EV, APPL_EV, USER_EV, SAMPLING_ADDRESS_L3_STORE_MISSES_EV,
	...
	MALLOC_EV, ADD_RESERVED_MEM_EV, SUB_RESERVED_MEM_EV, FREE_EV, CALLOC_EV, REALLOC_EV, POSIX_MEMALIGN_EV,
