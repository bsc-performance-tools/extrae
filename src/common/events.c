...
#define MPI_EVENTS 155  // Last added MPI_IEXSCAN_EV
...
static unsigned mpi_events[] = {
	...
	MPI_TESTANY_EV, MPI_TESTALL_EV, MPI_TESTSOME_EV, MPI_PROBE_EV,
	MPI_IPROBE_EV, MPI_MPROBE_EV, MPI_IMPROBE_EV, MPI_GATHER_EV, MPI_GATHERV_EV,
	...
	MPI_FILE_OPEN_EV, MPI_FILE_CLOSE_EV, MPI_FILE_READ_EV, MPI_FILE_READ_ALL_EV,
	MPI_FILE_WRITE_EV, MPI_FILE_WRITE_ALL_EV, MPI_FILE_READ_AT_EV,
	MPI_FILE_READ_AT_ALL_EV, MPI_FILE_WRITE_AT_EV, MPI_FILE_WRITE_AT_ALL_EV,
	MPI_IRECVED_EV, MPI_REQUEST_CANCELLED_EV, MPI_GET_EV, MPI_PUT_EV,
	MPI_COMM_CREATE_EV, MPI_COMM_CREATE_GROUP_EV, MPI_COMM_DUP_EV,
	MPI_COMM_DUP_WITH_INFO_EV, MPI_COMM_SPLIT_EV, MPI_COMM_SPLIT_TYPE_EV,
	MPI_CART_CREATE_EV, MPI_CART_SUB_EV, MPI_COMM_FREE_EV, MPI_COMM_SPAWN_EV,
	MPI_COMM_SPAWN_MULTIPLE_EV, MPI_REQUEST_GET_STATUS_EV,
	...
	MPI_INTERCOMM_CREATE_EV, MPI_INTERCOMM_MERGE_EV, MPI_IREDUCE_EV,
	MPI_IALLREDUCE_EV, MPI_IBARRIER_EV, MPI_IBCAST_EV, MPI_IALLTOALL_EV,
	MPI_IALLTOALLV_EV, MPI_IALLGATHER_EV, MPI_IALLGATHERV_EV, MPI_IGATHER_EV,
	MPI_IGATHERV_EV, MPI_ISCATTER_EV, MPI_ISCATTERV_EV, MPI_IREDUCESCAT_EV,
	MPI_ISCAN_EV, MPI_REDUCE_SCATTER_BLOCK_EV, MPI_IREDUCE_SCATTER_BLOCK_EV,
	...
	MPI_DIST_GRAPH_CREATE_ADJACENT_EV, MPI_NEIGHBOR_ALLGATHER_EV,
	MPI_INEIGHBOR_ALLGATHER_EV, MPI_NEIGHBOR_ALLGATHERV_EV,
	MPI_INEIGHBOR_ALLGATHERV_EV, MPI_NEIGHBOR_ALLTOALL_EV,
	MPI_INEIGHBOR_ALLTOALL_EV, MPI_NEIGHBOR_ALLTOALLV_EV,
	MPI_INEIGHBOR_ALLTOALLV_EV, MPI_NEIGHBOR_ALLTOALLW_EV,
	MPI_INEIGHBOR_ALLTOALLW_EV, MPI_FETCH_AND_OP_EV, MPI_COMPARE_AND_SWAP_EV,
	MPI_WIN_FLUSH_EV, MPI_WIN_FLUSH_ALL_EV, MPI_WIN_FLUSH_LOCAL_EV,
	MPI_WIN_FLUSH_LOCAL_ALL_EV, MPI_IMPROBE_COUNTER_EV, MPI_TIME_IN_IMPROBE_EV,
	MPI_MRECV_EV, MPI_IMRECV_EV, MPI_FILE_WRITE_ALL_BEGIN_EV,
	MPI_FILE_WRITE_ALL_END_EV, MPI_FILE_READ_ALL_BEGIN_EV,
	MPI_FILE_READ_ALL_END_EV, MPI_FILE_WRITE_AT_ALL_BEGIN_EV,
	MPI_FILE_WRITE_AT_ALL_END_EV, MPI_FILE_READ_AT_ALL_BEGIN_EV,
	MPI_FILE_READ_AT_ALL_END_EV, MPI_FILE_READ_ORDERED_EV,
	MPI_FILE_READ_ORDERED_BEGIN_EV, MPI_FILE_READ_ORDERED_END_EV,
	MPI_FILE_READ_SHARED_EV, MPI_FILE_WRITE_ORDERED_EV,
	MPI_FILE_WRITE_ORDERED_BEGIN_EV, MPI_FILE_WRITE_ORDERED_END_EV,
	MPI_FILE_WRITE_SHARED_EV, MPI_EXSCAN_EV, MPI_IEXSCAN_EV,
 };
 ...
 ***  IsMISC
 ******************************************************************************/
#define MISC_EVENTS 71
static unsigned misc_events[] = {FLUSH_EV, OPEN_EV, FOPEN_EV, READ_EV, WRITE_EV,
	FREAD_EV, FWRITE_EV, PREAD_EV, PWRITE_EV, READV_EV, WRITEV_EV, PREADV_EV,
	PWRITEV_EV, APPL_EV, USER_EV, SAMPLING_ADDRESS_L3_STORE_MISSES_EV,
	HWC_DEF_EV, HWC_CHANGE_EV, HWC_EV, TRACING_EV, SET_TRACE_EV, CALLER_EV,
	CPU_BURST_EV, RUSAGE_EV, MEMUSAGE_EV, USRFUNC_EV, SAMPLING_EV,
	SAMPLING_ADDRESS_LD_EV, SAMPLING_ADDRESS_ST_EV,
	SAMPLING_ADDRESS_MEM_LEVEL_EV, SAMPLING_ADDRESS_TLB_LEVEL_EV,
	SAMPLING_ADDRESS_REFERENCE_COST_EV, HWC_SET_OVERFLOW_EV, TRACING_MODE_EV,
	ONLINE_EV, USER_SEND_EV, USER_RECV_EV, RESUME_VIRTUAL_THREAD_EV,
	SUSPEND_VIRTUAL_THREAD_EV, TRACE_INIT_EV, REGISTER_STACKED_TYPE_EV,
	REGISTER_CODELOCATION_TYPE_EV, FORK_EV, WAIT_EV, WAITPID_EV, EXEC_EV,
	GETCPU_EV, CPU_EVENT_INTERVAL_EV, SYSTEM_EV, MALLOC_EV, ADD_RESERVED_MEM_EV,
	SUB_RESERVED_MEM_EV, FREE_EV, CALLOC_EV, REALLOC_EV, POSIX_MEMALIGN_EV,
	MEMKIND_MALLOC_EV, MEMKIND_CALLOC_EV, MEMKIND_REALLOC_EV,
	MEMKIND_POSIX_MEMALIGN_EV, MEMKIND_FREE_EV, MEMKIND_PARTITION_EV,
	SYSCALL_EV, KMPC_MALLOC_EV, KMPC_FREE_EV, KMPC_CALLOC_EV, KMPC_REALLOC_EV,
	KMPC_ALIGNED_MALLOC_EV, IOCTL_EV, CLOSE_EV, FCLOSE_EV
 };
...
unsigned IsMISC (unsigned EvType)
{
    ...
    if (EvType>=SAMPLING_EV && EvType<=SAMPLING_EV+MAX_CALLERS)
        return TRUE;
		if (EvType>=MPI_BURST_STATS_BASE && EvType<=MPI_BURST_STATS_BASE+MAX_CALLERS)
        return TRUE;
...
static unsigned omp_events[] = { OMPFUNC_EV, PAR_EV, WSH_EV, BARRIEROMP_EV, 
    ...
    OMPGETNUMTHREADS_EV, OMPTASKYIELD_EV, TASK_EV, TASKWAIT_EV, TASKFUNC_EV,
    TASKFUNC_LINE_EV, OMPT_CRITICAL_EV, OMPT_ATOMIC_EV, OMPT_LOOP_EV,
    OMPT_WORKSHARE_EV, OMPT_SECTIONS_EV, OMPT_SINGLE_EV, OMPT_MASTER_EV,
    TASKGROUP_START_EV, TASKGROUP_END_EV, TASKID_EV, TASKLOOPID_EV,
    OMPT_TASKGROUP_IN_EV, OMPT_DEPENDENCE_EV, OMPT_TASKFUNC_EV, OMP_STATS_EV,
    TASKLOOP_EV, ORDERED_EV, TARGET_EV, NEW_OMP_CALL_EV, NEW_OMP_NESTED_EV,
    NEW_OMP_PARALLEL_EV, NEW_OMP_WSH_EV, NEW_OMP_SYNC_EV, NEW_OMP_LOCK_EV,
    NEW_OMP_LOCK_NAME_EV, NEW_OMP_ORDERED_EV, NEW_OMP_TASKGROUP_EV,
    NEW_OMP_TASKING_EV, NEW_OMP_TARGET_EV, NEW_OMP_ADDRESS_EV,
    NEW_OMP_OUTLINED_ADDRESS_EV, NEW_OMP_OUTLINED_LINE_EV,
    NEW_OMP_TASK_INST_ID_EV, NEW_OMP_TASK_INST_ADDRESS_EV,
    NEW_OMP_TASK_INST_LINE_EV, NEW_OMP_TASK_EXEC_ID_EV,
    NEW_OMP_TASK_EXEC_ADDRESS_EV, NEW_OMP_TASK_EXEC_LINE_EV };
 ...
 ***  IsCUDA
 ******************************************************************************/
#define CUDA_EVENTS 8
static unsigned cuda_events[] = {
	/* Host events */
	CUDACALL_EV, CUDACALLGPU_EV, CUDA_DYNAMIC_MEM_PTR_EV, CUDA_DYNAMIC_MEM_SIZE_EV,
	CUDA_KERNEL_INST_EV, CUDASTREAMBARRIER_THID_EV, CUDA_KERNEL_EXEC_EV, CUDA_UNTRACKED_EV
};
