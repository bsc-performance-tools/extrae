 ...
 * IsGPI
 */
#define GPI_EVENTS 33
static unsigned gpi_events[] = {
	GPI_SIZE_EV, GPI_RANK_EV,
	GPI_INIT_EV, GPI_CONNECT_EV, GPI_DISCONNECT_EV, GPI_GROUP_CREATE_EV,
	GPI_GROUP_ADD_EV, GPI_GROUP_COMMIT_EV, GPI_GROUP_DELETE_EV,
	GPI_SEGMENT_ALLOC_EV, GPI_SEGMENT_REGISTER_EV, GPI_SEGMENT_CREATE_EV,
	GPI_SEGMENT_BIND_EV, GPI_SEGMENT_USE_EV, GPI_SEGMENT_DELETE_EV,
	GPI_WRITE_EV, GPI_READ_EV, GPI_WAIT_EV, GPI_NOTIFY_EV,
	GPI_NOTIFY_WAITSOME_EV, GPI_NOTIFY_RESET_EV, GPI_WRITE_NOTIFY_EV,
	GPI_WRITE_LIST_EV, GPI_WRITE_LIST_NOTIFY_EV, GPI_READ_LIST_EV,
	GPI_PASSIVE_SEND_EV, GPI_PASSIVE_RECEIVE_EV, GPI_ATOMIC_FETCH_ADD_EV,
	GPI_ATOMIC_COMPARE_SWAP_EV, GPI_BARRIER_EV, GPI_ALLREDUCE_EV,
	GPI_ALLREDUCE_USER_EV, GPI_TERM_EV
};
