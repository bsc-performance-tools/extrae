 ...
 * IsGASPI
 */
#define GASPI_EVENTS 33
static unsigned gaspi_events[] = {
	GASPI_SIZE_EV, GASPI_RANK_EV,
	...
	GASPI_WRITE_LIST_EV, GASPI_WRITE_LIST_NOTIFY_EV, GASPI_READ_LIST_EV,
	GASPI_PASSIVE_SEND_EV, GASPI_PASSIVE_RECEIVE_EV, GASPI_ATOMIC_FETCH_ADD_EV,
