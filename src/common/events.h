...
enum {
	...
	HIPMEMCPYTOSYMBOL_VAL,         /*TBD*/
	HIPMEMCPYFROMSYMBOL_VAL,       /*TBD*/
...
#define HIPCALLGPU_EV       63500001
enum {
	HIPKERNEL_GPU_VAL        = 1,
	HIPCONFIGKERNEL_GPU_VAL,
	HIPMEMCPY_GPU_VAL,
	HIPMEMCPYASYNC_GPU_VAL   = 7,
	HIPEVENTRECORD_GPU_VAL = 35
};

#define HIP_UNTRACKED_EV             63500003
#define HIP_DYNAMIC_MEM_SIZE_EV      63500004
#define HIP_DYNAMIC_MEM_PTR_EV       63500005
#define HIP_KERNEL_INST_EV           63500006
#define HIP_KERNEL_INST_LINE_EV      63500007
#define HIPSTREAMBARRIER_THID_EV     63500008  /* TID of the Paraver thid of the HIP stream being synchronized */
#define HIP_KERNEL_EXEC_EV           63500009
#define HIP_KERNEL_EXEC_LINE_EV      63500010
...
#define HIP_MEMORY_TRANSFER          63500014
