...
enum {
	...
	HIPHOSTALLOC_VAL,
	HIPMEMCPY2D_VAL,               /*TBD*/
	HIPMEMCPYTOARRAY_VAL,          /*TBD*/
	HIPMEMCPY2DTOARRAY_VAL,        /*TBD*/
	HIPMEMCPYFROMARRAY_VAL,        /*TBD*/
	HIPMEMCPY2DFROMARRAY_VAL,      /*TBD*/
	HIPMEMCPYARRAYTOARRAY_VAL,     /*TBD*/
	HIPMEMCPYTOSYMBOL_VAL,
	HIPMEMCPYFROMSYMBOL_VAL,
	HIPMEMCPYTOARRAYASYNC_VAL,     /*TBD*/
	HIPMEMCPYFROMARRAYASYNC_VAL,   /*TBD*/
	HIPMEMCPY2DASYNC_VAL,          /*TBD*/
	HIPMEMCPY2DTOARRAYASYNC_VAL,   /*TBD*/
	HIPMEMCPY2DFROMARRAYASYNC_VAL, /*TBD*/
	HIPMEMCPYTOSYMBOLASYNC_VAL,    /*TBD*/
	HIPMEMCPYFROMSYMBOLASYNC_VAL,  /*TBD*/
	HIPMEMSET_VAL,
	HIPMEMSETASYNC_VAL,
	HIPEVENTRECORD_VAL,
...
#define CUDACALLGPU_EV                63100000
enum {
	CUDAKERNEL_GPU_VAL           = 1,
	CUDACONFIGKERNEL_GPU_VAL,
	CUDAMEMCPY_GPU_VAL,
	CUDAMEMCPYASYNC_GPU_VAL      = CUDAMEMCPYASYNC_VAL,
	CUDAMEMCPYTOSYMBOL_GPU_VAL   = CUDAMEMCPYTOSYMBOL_VAL,
	CUDAMEMCPYFROMSYMBOL_GPU_VAL = CUDAMEMCPYFROMSYMBOL_VAL
};

#define HIPCALLGPU_EV                 63510000
enum {
	HIPKERNEL_GPU_VAL           = 1,
	HIPCONFIGKERNEL_GPU_VAL,
	HIPMEMCPY_GPU_VAL,
	HIPMEMCPYASYNC_GPU_VAL      = HIPMEMCPYASYNC_VAL,
	HIPMEMCPYTOSYMBOL_GPU_VAL   = HIPMEMCPYTOSYMBOL_VAL,
	HIPMEMCPYFROMSYMBOL_GPU_VAL = HIPMEMCPYFROMSYMBOL_VAL
};

#define CUDA_MEMORY_TRANSFER          63000001
#define CUDA_UNTRACKED_EV             63000003
#define CUDA_DYNAMIC_MEM_SIZE_EV      63000004
#define CUDA_DYNAMIC_MEM_PTR_EV       63000005
#define CUDA_KERNEL_EXEC_EV           63000006
#define CUDA_KERNEL_EXEC_LINE_EV      63000007
#define CUDA_STREAM_DEST_ID_EV        63000008  // Stream ID(Paraver TID) in which CUDA events are executed (target stream for record/sync operations).
#define CUDA_KERNEL_INST_EV           63000009
#define CUDA_KERNEL_INST_LINE_EV      63000010
...
#define HIP_MEMORY_TRANSFER           63500001
#define HIP_UNTRACKED_EV              63500003
#define HIP_DYNAMIC_MEM_SIZE_EV       63500004
#define HIP_DYNAMIC_MEM_PTR_EV        63500005
#define HIP_KERNEL_EXEC_EV            63500006
#define HIP_KERNEL_EXEC_LINE_EV       63500007
#define HIP_STREAM_DEST_ID_EV         63500008  // Stream ID(Paraver TID) in which CUDA events are executed (target stream for record/sync operations).
#define HIP_KERNEL_INST_EV            63500009
#define HIP_KERNEL_INST_LINE_EV       63500010
#define HIP_KERNEL_BLOCKS_PER_GRID    63500011
#define HIP_KERNEL_THREADS_PER_BLOCK  63500012
#define HIP_KERNEL_SHARED_MEM_BYTES   63500013
#define HIPEVENT_ID_EV                63500014
#define HIP_STREAM_REGISTER_EV        63500015
