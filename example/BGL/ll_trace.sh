...
#@ arguments = -exe /home/b12/harald/paquete/share/example/mpi_ping \
         ...
         -mode VN \
         -env "MPITRACE_ON=1 MPTRACE_COUNTERS=PAPI_TOT_CYC,PAPI_L3_TCM,BGL_UPC_TS_XM_32B_CHUNKS,BGL_UPC_TS_XP_32B_CHUNKS,BGL_UPC_TS_YM_32B_CHUNKS,BGL_UPC_TS_YP_32B_CHUNKS,BGL_UPC_TS_ZM_32B_CHUNKS,BGL_UPC_TS_ZP_32B_CHUNKS MPTRACE_BUFFER_SIZE=100000 MPITRACE_MPI_COUNTERS_ON=1" \
         -np $(tasks)
#
